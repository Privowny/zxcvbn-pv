  ...
  constructor(aLocale) {
    switch (aLocale) {
      case "fr": this.locale = {
        ...
        straightKeyRows: "Des rangées de caractères sur le clavier sont trop faciles à deviner",
        ...
        abcabcRepeats: "Une répétition telle que 'abcabcabc' est à peine sûr que 'abc'",
        repeatedWords: "Évitez les mots ou caractères répêtés",
        ...
        top10Password: "C'est un 10 des mots de passe les plus communs !",
        top100Password: "C'est un 100 des mots de passe les plus communs !",
